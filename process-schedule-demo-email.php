...
if (!$errors) {
    ...
    <head></head>
    <body>
	<h1>Localization Test Planning Wizard</h1>
    ...
    <table>
		...
		<tr><td>Demo Date</td><td>' . $demoDate . '</td></tr>
		<tr><td>Demo Time</td><td>' . $demoTime . '</td></tr>
		<tr><td>Demo Time Zone</td><td>' . $demoTimeZone . '</td></tr>
